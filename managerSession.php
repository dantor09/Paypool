...
<body>
	...
	<!-- button will possibly require php to trigger deleting session from individual in database; updates new manager -->
	...
	<?php
		//php logic goes here to view populated table of members in current session; ability to edit as manager
	?>
    <div>
